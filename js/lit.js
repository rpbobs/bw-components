...
class CMSHero extends LitElement {
  ...
  constructor() {
    super();
    this.src = "/rolex-blog/wp-content/uploads/2023/07/omega-watches-history.jpg";
  }
  ...
  connectedCallback() {
    super.connectedCallback();
    this.id = `bw--${CMSHero.instanceCounter++}`;
  }

  render() {
    return html`
      <picture>
        <source media="(min-width: 1921px)" srcset="https://cdn2.bobswatches.com/_/s:2560:360:1/q:50/dpr:2/sh:0.7/plain${this.src}" />
        <source media="(min-width: 1200px)" srcset="https://cdn2.bobswatches.com/_/s:1920:360:1/q:50/dpr:2/sh:0.7/plain${this.src}" />
        <source media="(min-width: 480px) and (max-width: 1199px)" srcset="https://cdn2.bobswatches.com/_/exar:1/rs:fill:768:256:0/q:50/dpr:2/sh:0.5/plain${this.src}" />
        <source media="(min-width: 0px) and (max-width: 479px)" srcset="https://cdn2.bobswatches.com/_/exar:1/rs:fill:480:256:0/q:50/dpr:2/sh:0.5/plain${this.src}" />
        <img class="heroIMG" src="https://cdn2.bobswatches.com/_/s:1920:0:1/q:50/dpr:2/sh:0.7/plain${this.src}" fetchpriority="high" loading="eager" alt="Hero image" />
      </picture>
    `;
  }
}
  ...
  render() {
    ...
    return html`
      <picture class="bw-picture">
        ...
        <source media="(min-width: 1920px)" srcset="${this.cdnURL}s:960:0:1${x1} 1x, ${this.cdnURL}s:960:0:1${x2} 2x, ${this.cdnURL}s:960:0:1${x3} 3x" />
  ...
  render() {
    return html`
      <section class="bw-fw-banner-container ${this.layout || "img-left"}" role="banner" aria-labelledby="${this.titleId}">
        ${this.variant === "video" ? html`<bw-ytembed ratio="${this.imgRatio}" videoID="${this.videoID}" image="${this.imgSrc}"></bw-ytembed>` : ""} ${this.variant !== "video" ? html`<bw-image src="${this.imgSrc}" lazy-loading="${this.lazyLoading}" priority="${this.imgPriority || "low"}" alt="${this.title} Banner Image" ratio=${this.imgRatio}></bw-image>` : ""}
        <div class="bw-fw-banner-content">
          ...
          <div class="bw-fw-banner-btn-container" style="margin-top: ${this.btnMarginTop ? "56px" : 0}"><slot name="cta"></slot></div>
        </div>
      </section>
    `;
  }
